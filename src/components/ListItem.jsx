...
const ListItem = ({ todo, allTodos, setTodos, i }) => {
  ...
  return (
    <>
      {
        isEdit
          ? <EditMode todo={todo} handleUpdate={handleUpdate} setIsEdit={setIsEdit} i={i} />
          : <ContentMode todo={todo} handleDelete={handleDelete} setIsEdit={setIsEdit} i={i} />
      }
    </>
  )
}
...
export default ListItem
  ...
  /**
    <tr className='list-group-item relative p-2 d-flex justify-content-between align-items-center gap-3'>
    </tr>
    */
